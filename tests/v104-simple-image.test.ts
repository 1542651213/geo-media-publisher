...
describe("V1.0.4 simple import and image library", () => {
  ...
  it("auto-selects one account, requires a choice for multiple accounts, and persists image matching", () => {
    ...
    const best = repository.createImageAsset({ brandId: brand.id, name: "业务城市平台图", filePath: "C:/media/best.jpg", originalFileName: "best.jpg", mimeType: "image/jpeg", size: 10, business: ["甲醛治理"], city: ["苏州"], platform: ["zhihu"], universal: false });
