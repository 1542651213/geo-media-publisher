...
class LiejuL5Fixture implements PlatformAdapter {
  ...
  readonly prepareFinalSubmit = vi.fn(async () => {
    if (this.prepareFinalSubmit.mock.calls.length === 1) throw Object.assign(new Error("CAPTCHA: complete normal platform verification"), { code: "USER_ACTION_REQUIRED" });
    return { response: {} };
  });
