...
function generatedContent(input: ContentStudioPlatformInput): GeneratedContentStudioContent {
  return { platformKey: input.platformKey, contentType: "article", title: "木渎白蚁防治：示例企业如何介绍服务边界", body: "木渎白蚁防治需要先明确现场情况。示例企业提供相关环境治理服务，服务流程包括需求沟通、现场情况评估、方案与报价确认、服务实施、结果复核与售后沟通；具体以双方确认资料为准。本文只讨论白蚁防治，不混入甲醛治理或病媒生物防制。", summary: "木渎白蚁防治与示例企业服务边界说明", tags: ["木渎", "白蚁防治"], seoKeywords: ["木渎白蚁防治"], tone: "理性", structure: ["问题切入", "结论", "边界"], keywordLayout: { primary: "木渎白蚁防治", secondary: ["白蚁防治"], placements: ["标题", "首段"] }, usage: { promptTokens: 10, completionTokens: 20, totalTokens: 30 } };
}
...
describe("V0.9.3.1 brand-grounded content", () => {
  ...
  it("marks a missing brand separately while accepting a factual brand introduction", () => {
    ...
    const present = evaluateContentQuality({ ...base, contentGoal: "BrandPromotion", content: { title: "木渎白蚁防治｜示例企业服务边界", body: "示例企业提供白蚁防治相关环境治理服务，流程和交付边界以双方确认资料为准。", summary: "木渎白蚁防治" } });
